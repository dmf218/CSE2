...
public class Arithmetic {
    ...
    public static void main(String[] args) {
        ...
        double taxTotalGlassesCost$=((salesTaxGlasses$+totalGlassesCost$)*100)/100.0;   //determine cost of glasses with tax
        ...
        System.out.println("The total cost of the entire purchase with tax is $"+(taxTotalSockCost$+taxTotalGlassesCost$+taxTotalEnvelopeCost$)); 
    }
}